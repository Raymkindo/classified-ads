                    ...
                    <div class="card-body">
                      ...
                      <div class="border-top border-dashed pt-4">
                        <div class="row flex-between-center mb-2">
                          ...
                          <div class="col-auto"><a class="lh-1" href="mailto:{{ Auth::user()->email }}">{{ Auth::user()->email }}</a></div>
                        </div>
                  ...
                  <div class="tab-pane fade" id="tab-stores" role="tabpanel" aria-labelledby="wishlist-tab">
                        ...
                        <table class="table table-sm fs-9 mb-0">
                          ...
                          <tbody class="list" id="profile-stores-table-body">
                            ...
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                              ...
                              <td class="color align-middle white-space-nowrap fs-9 text-body"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light"></span><span class="fa-regular fa-star text-warning-light"></span></td>
                            ...
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                              ...
                              <td class="color align-middle white-space-nowrap fs-9 text-body"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light"></span></td>
                    ...
                    <div class="row gx-3 gy-5">
                      ...
                      <div class="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
                        ...
                        <div class="mb-1 fs-9"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light"></span><span class="fa-regular fa-star text-warning-light"></span></div>
                      ...
                      <div class="col-6 col-sm-4 col-md-3 col-lg-2 hover-actions-trigger btn-reveal-trigger">
                        ...
                        <div class="mb-1 fs-9"><span class="fa fa-star text-warning"></span><span class="fa fa-star text-warning"></span><span class="fa-regular fa-star text-warning-light"></span><span class="fa-regular fa-star text-warning-light"></span><span class="fa-regular fa-star text-warning-light"></span></div>
